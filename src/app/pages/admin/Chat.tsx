...
import { MessageSquare, Send, Search, Users, Phone, Mail } from 'lucide-react';
  ...
  const mockUsers: User[] = [
    {
      ...
      avatar: 'AJ',
      lastMessage: 'I need help with the new feature',
    ...
    },
    {
      ...
      avatar: 'DW',
      lastMessage: 'Can we discuss the report?',
  ...
  const mockMessages: Message[] = [
    {
      ...
      message: 'Hi, I need help with the new feature implementation.',
      timestamp: '2:30 PM',
      isOwn: false
    },
    {
      ...
      senderId: 'me',
      senderName: 'You',
      message: 'Hello Alice! I\'d be happy to help. What specific feature are you working on?',
      timestamp: '2:32 PM',
      isOwn: true
    },
    {
      ...
      senderId: '1',
      senderName: 'Alice Johnson',
      message: 'I need help with the new feature',
      timestamp: '2:35 PM',
      isOwn: false
    }
  ];
